...
<img width="837" height="783" alt="Backend" src="https://github.com/user-attachments/assets/030edf24-12ee-45d3-a1cc-72a744a349f3" />
...
APIs: Los puntos de contacto que permiten al Frontend (la pantalla del usuario) enviar solicitudes y recibir datos del servidor.
Lógica de Negocio: El código que procesa las reglas del sistema (por ejemplo, verificar si hay stock antes de cobrar una compra).

Lenguajes y herramientas comunes
Lenguaje / Entorno      Frameworks populares
JavaScript /            TypeScriptNode.js, Express, NestJS
